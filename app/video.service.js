...
var VideoService = (function () {
    function VideoService(http) {
        ...
        this.timerFired = function () {
            if (!_this.isDragging && _this.isPlaying) {
                ...
                _this.calculatedWidth = (time / duration * _this.videoElement.offsetWidth);
                if (time == duration) {
                    _this.isPlaying = false;
                    _this.videoElement.pause();
                }
    ...
    VideoService.prototype.appSetup = function (id) {
    ...
    VideoService.prototype.seekVideo = function (e) {
        var width = document.getElementById('progressMeterFull').offsetWidth;
        var duration = this.videoElement.duration;
        var seconds = Math.round(e.pageX / width * duration);
